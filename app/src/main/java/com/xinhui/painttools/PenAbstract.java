...
import com.xinhui.interfaces.ShapesInterface;
...
abstract public class PenAbstract implements ToolInterface, Shapable {
	...
	public PenAbstract(int size, int penColor, int mPaintType) {
	...
	public void touchDown(float x, float y) {
		saveDownPoint(x, y);
		// clear the lines of the path
		mPath.reset();
		// set the next down point to (x,y)
		mPath.moveTo(x, y);
		savePoint(x, y);
	}
